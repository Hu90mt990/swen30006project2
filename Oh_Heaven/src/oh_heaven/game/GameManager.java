...
public class GameManager extends CardGame {
	...
	private void initScore() {
		 for (int i = 0; i < nbPlayers; i++) {
			 // scores[i] = 0;
			 String text = "[" + String.valueOf(scores[i]) + "]" + String.valueOf(tricks[i]) + "/" + String.valueOf(players[i].bid);
	...
	private void updateScore(int player) {
		...
		String text = "[" + String.valueOf(scores[player]) + "]" + String.valueOf(tricks[player]) + "/" + String.valueOf(players[player].bid);
